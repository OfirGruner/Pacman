...
//todo gamespeed/difficulity: the higher the difficult - the faster ghosts are moving // smart movement.
...
var rows = 15;//todo .
var cols = 15;
var difficultLevel=502;//todo get from user
var numberOfWalls;
...
//
    ...
    // var smiley; // bonus character
    // var timeBonus;
    // var enemiesNumber = 3;//todo input from user -   1 to 3
    // var enemies;
    // var rows = 15;//todo .
    // var cols = 15;
    // var difficultLevel=250;//todo get from user
    // var numberOfWalls;
    // var timesBetweenCollisions;
    // var pacmanSpeed;
    // var lastCollision;
    ...
    //     lives=3;
    //     pacmanSpeed=250;
    //     timesBetweenCollisions=Math.max(difficultLevel,pacmanSpeed)
    //     board = new Array();
    //     score = 0;
    //     pac_color = "yellow";
    //     smiley = new Smiley(rows-2,cols-2);
    //
    //     var food_remain = 80; //todo input from user 50 to 90
    //     var pts5 = 0.6 * food_remain;
    //     var pts15 = 0.3 * food_remain;
    //     var pts25 = food_remain - pts5 - pts15;
    //     var pacman_remain = 1;
    ...
    //             board[i][j] = 1;
    //             pts5--;
    //         } else if (randomNum < 1.0 * (pacman_remain + food_remain) / 100) {//todo will always generate pacman?
    //             shape.i = i;
    //             shape.j = j;
    //             pacman_remain--;
    //             board[i][j] = 2;
    ...
    //
    // function Draw() {
    //     lblMyLocation.value = shape.i+""+shape.j;
    //     context.clearRect(0, 0, canvas.width, canvas.height); //clean board
    //     lblScore.value = score;
    //     lblTime.value = time_elapsed;
    //     lblLives.value = lives;
    ...
    //             window.clearInterval(interval);
    //             window.clearInterval(interval2);
    //         if(score >= 150){window.alert("We have a Winner!!!");
    //
    //         }
    //         else{
    //             window.alert("You can do better");
